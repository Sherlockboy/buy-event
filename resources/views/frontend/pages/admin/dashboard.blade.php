                                    ...
                                    <tr>
                                            ...
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0">
                                                    <a href="#" class="block relative">
                                                        <img alt="product" src="https://images.unsplash.com/photo-1542156822-6924d1a71ace?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0">
                                                    <a href="#" class="block relative">
                                                        <img alt="product" src="{{ $order->product->image }}" class="mx-auto object-cover rounded-md h-10 w-10 "/>
                                                    </a>
                                                </div>
                                                <div class="ml-3">
                                                    <p class="text-gray-900 whitespace-no-wrap">
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <div x-data="{ open: false }" class="relative">
                                                <button @click="open = true" type="button" class="px-2 py-1 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-green-600 rounded-md dark:bg-gray-800 hover:bg-green-500 dark:hover:bg-gray-700 focus:outline-none focus:bg-green-500 dark:focus:bg-gray-700" aria-label="toggle accept dropdown">
                                                    Accept
                                                </button>
                                            
                                                <ul class="absolute right-0 bottom-6 z-20 w-48 mt-2 overflow-hidden bg-white rounded-md shadow-xl dark:bg-gray-700"
                                                    x-show="open"
